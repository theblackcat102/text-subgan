...
def model_opts(parser):
    ...
    group.add('--template_word_vec_size', '-template_word_vec_size',
              type=int, default=500,
              help='Word embedding size for template.')
...
def preprocess_opts(parser):
    ...
    group.add('--train_template', '-train_template', required=True,
              help="Path(s) to the training template data")
    group.add('--train_align', '-train_align', default=[None],
              help="Path(s) to the training src-tgt alignment")
    group.add('--train_ids', '-train_ids', default=[None],
    ...
    group.add('--valid_template', '-valid_template',
    ...
    group.add('--test_tgt', '-test_tgt',
              help="Path to the validation target data")
    group.add('--test_template', '-test_template',
              help="Path to the validation template data")

    group.add('--user_data', '-user_data',
              help="Path to the user dataset")
    ...
    group.add('--tgt_vocab', '-tgt_vocab', default="",
              help="Path to an existing target vocabulary. Format: "
                   "one word per line.")
    group.add('--template_vocab', '-template_vocab', default="",
              help="Path to an existing template vocabulary. Format: "
                   "one word per line.")
    ...
    group.add('--template_vocab_size', '-template_vocab_size', type=int, default=100000,
              help="Size of the template vocabulary")
    ...
    group.add('--template_words_min_frequency',
              '-template_words_min_frequency', type=int, default=0)
    ...
    group.add('--template_seq_length', '-template_seq_length', type=int, default=1000,
              help="Maximum target sequence length to keep.")
    group.add('--template_seq_length_trunc', '-template_seq_length_trunc',
              type=int, default=None,
              help="Truncate target sequence length.")
...
def translate_opts(parser):
    ...
    group.add('--src_dir', '-src_dir', default="",
              help='Source directory for image or audio files')
    group.add('--template', '-template', required=True,

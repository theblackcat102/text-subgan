...
class RelGANTrainer():
    ...
    def __init__(self, args):
        ...
        self.G = RelGAN_G(args.mem_slots, args.num_heads, args.head_size, args.gen_embed_dim, 
            ...
            max_seq_len=args.max_seq_len, padding_idx=Constants.PAD, gpu=True)
        self.D = RelGAN_D(args.dis_embed_dim, args.max_seq_len, args.num_rep, dataset.vocab_size, Constants.PAD,
    ...
    def pretrain_generator(self, epochs, writer=None):
        ...
        for epoch in range(epochs):
            ...
            torch.save(self.G.state_dict(), 'save/relgan_G_pretrained.pt')
    ...
    def adv_train_generator(self, g_step=1):
        ...
        for step in range(g_step):
            ...
            g_loss, _ = get_losses(d_out_real, d_out_fake, 'rsgan')
    ...
    def adv_train_discriminator(self, d_step=1):
        ...
        for step in range(d_step):
            ...
            d_out_real = self.D(real_samples)
            d_out_fake = self.D(gen_samples)
            _, d_loss = get_losses(d_out_real, d_out_fake, 'rsgan')
    ...
    def train(self):
        ...
        writer = SummaryWriter('logs/relgan-{}'.format(datetime.now().strftime('%Y-%m-%d-%H-%M-%S')))

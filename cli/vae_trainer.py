...
class TemplateTrainer():
    ...
    def step(self, i):
        ...
        tmp2_outputs, tmp2_latent = self.model.encode_tmp(tmp2)
        output2_target, output2_logits = self.model.decode(tmp2_latent, desc2_latent, user2_embed, 
            desc2_outputs, tmp2_outputs,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='rec_vae')

...
class SubSpaceRelGANTrainer():
    ...
    def __init__(self, args):
        self.dataset = KKDayUser(-1, 'data/kkday_dataset/user_data', 
            ...
            prefix='item_graph', max_length=args.max_seq_len, force_fix_len=args.grad_penalty or args.full_text, 
        ...
        attention = LuongAttention(args.gen_hidden_dim, args.gen_hidden_dim)
    ...
    def adv_train_generator(self, g_step=1):
        ...
        for step in range(g_step):
            ...
            if cfg.CUDA:
                inputs, users = inputs.cuda(), users.cuda()
